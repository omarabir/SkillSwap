  ...
  return (
    ...
    >
      <div className="relative">
        ...
        <div className="absolute top-3 left-3  bg-[#f5d5d6]  text-[#FF1E1E] text-xs px-3 py-1.5 font-bold  rounded-full shadow-md">
      ...
      <div className="p-6 grow flex flex-col">
        ...
        <div className="mt-auto">
          <Link
            ...
            className="block font-semibold w-full text-center bg-linear-to-r from-[#FF1E1E] to-[#FF6560] text-white py-2 rounded-md  transition-colors duration-300  hover:from-[#FF6560] hover:to-[#FF1E1E]"
          >
            See more
          </Link>
        </div>
